...
class TestEvaluateTask(unittest.TestCase):
    ...
    def setUp(self, *args):
        ...
        self.current_update = backend().request_backend_evaluate(
            repository_authorization=self.repository_authorization, language="pt_br"
        )
    ...
    @patch(
        ...
        return_value={
            ...
            "bot_data": "https://s3.amazonaws.com/bothub-teste/repository_6647/bot_data_d20ddc1f-efd0-443a-8c6c-e37d2e672170.tar.gz",
            "from_aws": True,
        },
    )
    @patch(
