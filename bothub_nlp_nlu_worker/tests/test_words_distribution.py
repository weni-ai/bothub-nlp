...
from bothub_nlp_nlu_worker.tests.celery_app import train_update, words_distribution
...
class TestWordDistributionTask(unittest.TestCase):
    ...
    def setUp(self, *args):
        ...
        self.current_update = backend().request_backend_train(
    ...
    @patch(
        ...
        return_value={
            "version_id": 6647,
            "repository_uuid": "e1e8a0fa-625c-4ba3-8b91-4c9f308db791",
            "bot_data": "https://s3.amazonaws.com/bothub-teste/repository_6647/bot_data_4750816f-f3c4-4c0a-80b8-9930c218226c.tar.gz",
            "from_aws": True,
        },
    )
    @patch(
