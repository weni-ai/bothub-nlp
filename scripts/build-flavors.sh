...
DOCKER_IMAGE_FLAVOR="-full" DOWNLOAD_LANGUAGES_ON_DOCKER_IMAGE_BUILD="en:en_core_web_lg|de|es:es_core_news_md|pt|fr:fr_core_news_md|it|nl|pt_br:pip+pt_br_vectors_web_lg:https://s3.amazonaws.com/bothub-models/spacy/pt_br_vectors_web_lg-1.0.0.tar.gz" docker-compose -f docker/docker-compose.yml build bothub-nlp
