...
class TestEvaluateTask(unittest.TestCase):
    ...
    @patch(
        ...
        return_value=[
            ...
            {"text": "aceito sim, muito obrigado", "intent": "affirmative", "entities": []},
            ...
            {"text": "posso sim! me confirma a data", "intent": "affirmative", "entities": []},
            {"text": "claro que estou disponivel", "intent": "affirmative", "entities": []},
            ...
            {"text": "adorei a ideia vamos sim", "intent": "affirmative", "entities": []},
            ...
            {"text": "não, como faço para reconhecer?", "intent": "negative", "entities": []},
            ...
            {"text": "eu também estou num relacionamento abusivo", "intent": "bias", "entities": []},
            {"text": "já", "intent": "affirmative", "entities": []},
            {"text": "hoje já estou num relacionamento abusivo", "intent": "bias", "entities": []},
            ...
            {"text": "meu namorado bateu na minha cara", "intent": "bias", "entities": []},
            {"text": "não ne!! meu namorado bateu na minha cara", "intent": "bias", "entities": []},
